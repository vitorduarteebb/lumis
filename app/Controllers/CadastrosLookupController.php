...
final class CadastrosLookupController extends Controller
{
    ...
    public function index(Request $request): string
    {
        ...
        $type = (string) $request->input('type', 'client_type');
        ...
        return $this->view('cadastros/lookups/index', [
            ...
            'search' => $q,
            'basePath' => '/cadastros/opcoes-auxiliares',
    ...
    public function create(Request $request): string
    {
        ...
        return $this->view('cadastros/lookups/form', [
            'title' => 'Novo item',
            'pageTitle' => 'Novo item — ' . self::TYPES[$type],
            'breadcrumbs' => [
                ['label' => 'Início', 'href' => '/dashboard'],
                ['label' => 'Cadastros', 'href' => null],
                ['label' => 'Opções auxiliares', 'href' => '/cadastros/opcoes-auxiliares?type=' . rawurlencode($type)],
    ...
    public function store(Request $request): string
    {
        ...
        if (!Csrf::validate($request->input('_csrf_token'))) {
            ...
            redirect('/cadastros/opcoes-auxiliares');
        }
        ...
        redirect('/cadastros/opcoes-auxiliares?type=' . rawurlencode($type));
    }
