...
final class NotasFiscaisLookupController extends Controller
{
    private const PER_PAGE = 20;

    /** @var array<string, string> */
    private const TYPES = [
        'fiscal_series' => 'Séries fiscais',
        'fiscal_operation_nature' => 'Naturezas de operação',
        'fiscal_cfop' => 'CFOP (auxiliares)',
        'fiscal_note_status' => 'Rótulos / status auxiliares',
        'fiscal_document_model' => 'Modelos de nota',
        'fiscal_admin_config' => 'Configurações administrativas',
    ];

    private const BASE = '/notas-fiscais/opcoes-auxiliares';

    public function index(Request $request): string
    {
        $cid = $this->requireCompany();
        $type = (string) $request->input('type', 'fiscal_series');
        ...
        return $this->view('notas_fiscais/lookups/index', [
    ...
    public function create(Request $request): string
    {
        ...
        return $this->view('notas_fiscais/lookups/form', [
            'title' => 'Novo item',
