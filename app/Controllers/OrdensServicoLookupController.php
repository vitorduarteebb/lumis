...
/**
 * Opções auxiliares de ordens de serviço (lookup_entries).
 */
final class OrdensServicoLookupController extends Controller
{
    private const PER_PAGE = 20;

    /** @var array<string, string> */
    private const TYPES = [
        'os_status' => 'Status da O.S.',
        'os_priority' => 'Prioridades',
        'os_type' => 'Tipos de O.S.',
        'os_category' => 'Categorias',
    ];

    public function index(Request $request): string
    {
        $cid = $this->requireCompany();
        $type = (string) $request->input('type', 'os_status');
        ...
        return $this->view('ordens_servico/lookups/index', [
            ...
            'search' => $q,
            'basePath' => '/ordens-servico/opcoes-auxiliares',
    ...
    public function create(Request $request): string
    {
        ...
        return $this->view('ordens_servico/lookups/form', [
            'title' => 'Novo item',
            'pageTitle' => 'Novo — ' . self::TYPES[$type],
            'breadcrumbs' => [
                ['label' => 'Início', 'href' => '/dashboard'],
                ['label' => 'Ordens de serviço', 'href' => '/ordens-servico'],
                ['label' => 'Opções auxiliares', 'href' => '/ordens-servico/opcoes-auxiliares?type=' . rawurlencode($type)],
    ...
    public function store(Request $request): string
    {
        ...
        if (!Csrf::validate($request->input('_csrf_token'))) {
            ...
            redirect('/ordens-servico/opcoes-auxiliares');
        }
        ...
        redirect('/ordens-servico/opcoes-auxiliares?type=' . rawurlencode($type));
    }
