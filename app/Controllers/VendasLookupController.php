...
final class VendasLookupController extends Controller
{
    private const PER_PAGE = 20;

    /** @var array<string, string> */
    private const TYPES = [
        'vendas_payment_method' => 'Formas de pagamento',
        'vendas_payment_terms' => 'Condições de pagamento',
        'vendas_sale_status' => 'Status de venda',
        'vendas_channel' => 'Canais de venda',
    ];

    private const BASE = '/vendas/opcoes-auxiliares';

    public function index(Request $request): string
    {
        $cid = $this->requireCompany();
        $type = (string) $request->input('type', 'vendas_payment_method');
        if (!isset(self::TYPES[$type])) {
            $type = 'vendas_payment_method';
        }
        ...
        return $this->view('vendas/lookups/index', [
    ...
    public function create(Request $request): string
    {
        ...
        return $this->view('vendas/lookups/form', [
            'title' => 'Novo item',
