...
$currentType = (string) ($currentType ?? 'vendas_payment_method');
$rows = $rows ?? [];
$basePath = (string) ($basePath ?? '/vendas/opcoes-auxiliares');
...
<div class="lumis-page-head">
    <div>
        ...
        <div class="text-secondary small">Formas de pagamento, condições e status para as telas de venda.</div>
    </div>
    <?php if (can('vendas.opcoes_auxiliares.create')): ?>
