...
$action = $isEdit ? '/contratos/locacoes/' . $id : '/contratos/locacoes';
...
<form class="lumis-form" method="post" action="<?= htmlspecialchars($action, ENT_QUOTES, 'UTF-8') ?>" enctype="multipart/form-data">
    ...
    <div class="lumis-form-section row g-3">
        <div class="col-md-4">
            ...
            <input type="text" name="contract_number" class="form-control app-input" value="<?= htmlspecialchars((string) ($row['contract_number'] ?? ''), ENT_QUOTES, 'UTF-8') ?>">
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-6">
            <label class="form-label lumis-label">Item / bem locado</label>
            <input type="text" name="asset_description" class="form-control app-input" value="<?= htmlspecialchars((string) ($row['asset_description'] ?? ''), ENT_QUOTES, 'UTF-8') ?>">
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            <label class="form-label lumis-label">Caução (R$)</label>
            <input type="text" name="deposit_amount" class="form-control app-input" value="<?= htmlspecialchars((string) ($row['deposit_amount'] ?? ''), ENT_QUOTES, 'UTF-8') ?>">
        </div>
        <div class="col-md-3">
    ...
    <div class="mt-3 d-flex gap-2 justify-content-end">
        <a class="btn btn-lumis-secondary" href="/contratos/locacoes">Cancelar</a>
        <?php if ($isEdit ? can('contratos.locacoes.edit') : can('contratos.locacoes.create')): ?>
