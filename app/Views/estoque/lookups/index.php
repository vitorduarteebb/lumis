...
$currentType = (string) ($currentType ?? 'estoque_adjust_reason');
$rows = $rows ?? [];
$basePath = (string) ($basePath ?? '/estoque/opcoes-auxiliares');
?>
<div class="lumis-page-head">
    ...
    <?php if (can('estoque.opcoes_auxiliares.create')): ?>
...
<div class="lumis-table-wrap mb-2">
    <table class="table lumis-table mb-0">
        ...
        <tbody>
            <?php if ($rows === []): ?><tr><td colspan="5" class="text-secondary py-4">Nenhum item.</td></tr><?php endif; ?>
            <?php foreach ($rows as $row): ?>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        <?php if (can('estoque.opcoes_auxiliares.edit')): ?><a class="btn btn-sm btn-lumis-secondary" href="<?= htmlspecialchars($basePath, ENT_QUOTES, 'UTF-8') ?>/<?= $rid ?>/editar">Editar</a><?php endif; ?>
                        <?php if (can('estoque.opcoes_auxiliares.delete')): ?>
