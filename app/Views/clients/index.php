...
$basePath = (string) ($basePath ?? '/cadastros/clientes');
...
<div class="lumis-page-head">
    <div>
        ...
        <h2 class="h4 mb-1 text-white">Clientes</h2>
        <div class="text-secondary small">Pessoa física e jurídica com endereço e contatos.</div>
    </div>
    <?php if (can('cadastros.clientes.create') || can('clients.create')): ?>
        <a class="btn btn-primary btn-sm rounded-3" href="/cadastros/clientes/novo">Novo cliente</a>
    <?php endif; ?>
</div>
...
<div class="lumis-table-wrap mb-2">
    <table class="table lumis-table mb-0">
        ...
        <tbody>
            <?php if ($rows === []): ?>
                <tr><td colspan="5" class="text-secondary small py-4">Nenhum cliente encontrado.</td></tr>
            <?php endif; ?>
                    ...
                    <td class="text-end">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end app-dropdown border-0">
                                <li><a class="dropdown-item" href="/cadastros/clientes/<?= $rid ?>">Ver</a></li>
                                <?php if (can('cadastros.clientes.edit') || can('clients.edit')): ?>
                                    <li><a class="dropdown-item" href="/cadastros/clientes/<?= $rid ?>/editar">Editar</a></li>
                                <?php endif; ?>
                                <?php if (can('cadastros.clientes.delete') || can('clients.edit')): ?>
                                    <li>
                                        <form method="post" action="/cadastros/clientes/<?= $rid ?>/excluir" class="m-0" onsubmit="return confirm('Excluir este cliente?');">
