...
$currentType = (string) ($currentType ?? 'fiscal_series');
$rows = $rows ?? [];
$basePath = (string) ($basePath ?? '/notas-fiscais/opcoes-auxiliares');
?>
<div class="lumis-page-head">
    ...
    <?php if (can('notas_fiscais.opcoes_auxiliares.create')): ?>
        ...
        <tbody>
            ...
            <?php foreach ($rows as $row): ?>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        <?php if (can('notas_fiscais.opcoes_auxiliares.edit')): ?><a class="btn btn-sm btn-lumis-secondary" href="<?= htmlspecialchars($basePath, ENT_QUOTES, 'UTF-8') ?>/<?= $rid ?>/editar">Editar</a><?php endif; ?>
                        <?php if (can('notas_fiscais.opcoes_auxiliares.delete')): ?>
